...
var Buffer = (function () {
  ...
  _createClass(Buffer, [{
    ...
    value: function get() {
      this._flush();
      var map = this._map;
      var result = Object.defineProperties({
    ...
    value: function _append(str, sourcePos, maybeNewline) {
      ...
      var identifierName = sourcePos.identifierName;
      var identifierNamePos = sourcePos.identifierNamePos;
      var filename = sourcePos.filename;
