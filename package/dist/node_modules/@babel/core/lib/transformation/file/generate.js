...
function generateCode(pluginPasses, file) {
      ...
      try {
        for (var _iterator2 = plugins[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          if (generatorOverride) {
            var _result = generatorOverride(ast, generatorOpts, code, _generator()["default"]);
            if (_result !== undefined) results.push(_result);
          }
        }
      } catch (err) {
  ...
  var _result2 = result;
  var outputCode = _result2.code;
  var _result2$decodedMap = _result2.decodedMap;
  var outputMap = _result2$decodedMap === undefined ? result.map : _result2$decodedMap;
