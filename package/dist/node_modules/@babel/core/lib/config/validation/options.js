...
function throwUnknownError(loc) {
  ...
  if (_removed["default"][key]) {
    ...
    var message = _removed$default$key.message;
    var _removed$default$key$version = _removed$default$key.version;
    var version = _removed$default$key$version === undefined ? 5 : _removed$default$key$version;

    throw new Error("Using removed Babel " + version + " option: " + (0, _optionAssertions.msg)(loc) + " - " + message);
  } else {
    var unknownOptErr = new Error("Unknown option: " + (0, _optionAssertions.msg)(loc) + ". Check out https://babeljs.io/docs/en/babel-core/#options for more information about options.");
